...
export const metadata: Metadata = {
  title: "Apple T-Shirts - Unique Collection",
  description: "Explore our collection of high-quality Apple-themed t-shirts designed for comfort and style.",
  openGraph: {
    title: "Apple T-Shirts - Unique Collection",
    description: "Explore our collection of high-quality Apple-themed t-shirts designed for comfort and style.",
    siteName: "Apple T-Shirts",
    images: [{ url: "https://images.pexels.com/photos/2112648/pexels-photo-2112648.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website"
  }
};
